...
namespace TypeScript.Compiler
{
    ...
    {
        Dictionary<string, TypeScriptType> cache;

        public Dictionary<string, TypeScriptType> Cache { get { return cache; } }

        public List<int> TupleTypesByCount { get; set; }
        ...
        public TypeScriptType MakeFromNullable(Type type)
        {
        ...
        public TypeScriptType MakeFromTask(Type type)
        {
            var name = "void";
        ...
        public TypeScriptType MakeArray(Type type)
        {
            if (type.GenericTypeArguments.Count() != 1)
            {
        ...
        TypeScriptType MakeDictionary(Type type)
        {
        ...
        TypeScriptType MakeTuple(Type type)
        {
        ...
        TypeScriptType MakeEnum(Type type)
        {
            var name = type.Name;
        ...
        TypeScriptType MakeClassOrInterface(Type type)
        {
            var declaration = "";
            var name = type.Name;
