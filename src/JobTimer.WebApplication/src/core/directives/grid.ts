...
namespace Core {
    ...
    angular.module('core')
        .directive('slickGrid', ["$window", "$timeout", "$stateParams", "ajaxer", "locker", "notifier", ($window: ng.IWindowService, $timeout: ng.ITimeoutService, $stateParams, ajaxer: Core.Ajaxer, locker: Core.Locker, notifier: Core.Notifier) => {
            return {
                restrict: "A",
                        ...
                        handleCreate: function() {
                            ...
                            grid.onHeaderRowCellRendered.subscribe(function(e, args) {
                                if (args.column && args.column.field) {
                                    var col: IColumn = _.find(columns, (val: IColumn) => { return val.field === args.column.field; });
                                    if (col.filter === true) {
                                        $(args.node).empty();
                            ...
                            loader.onDataLoadError.subscribe(() => {
