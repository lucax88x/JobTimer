...
/// <reference path="../../../typings/sortable/sortable.d.ts" />
var Core;
(function (Core) {
    angular.module('core')
        ...
        .directive('ngSortable', ['$parse', function ($parse) {
            ...
            return {
                ...
                link: function (scope, $el, attrs) {
                    var el = $el[0], options = scope.ngSortable || {}, source = getSource(el), watchers = [], sortable;
                    ...
                    function _sync(/**Event*/ evt) {
                        ...
                        var oldIndex = evt.oldIndex, newIndex = evt.newIndex, items = source.items();
                        if (el !== evt.from) {
                            var prevSource = getSource(evt.from), prevItems = prevSource.items();
